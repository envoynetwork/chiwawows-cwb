...
export const PROGRAM_ID = new anchor.web3.PublicKey('odEajWBpBtBTLUYqySYq68iCE3rQ3HrQGWNHp7TijvL');
export const POOL_ID = new anchor.web3.PublicKey('79RysV2dCP1FXj643RtnTGMhfCDTrtLyLB1xTSS7WvRD');
export const AIRDROP_TOKEN_MINT = new anchor.web3.PublicKey('53W1csx5gsyjTL5VAM2jNaP5oDS3qbgLwikBeEDEVHZj');
